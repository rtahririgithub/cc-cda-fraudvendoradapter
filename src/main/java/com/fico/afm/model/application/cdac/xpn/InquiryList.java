 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Inquiry" type="{http://fico.com/dms/fidms/cc/cdac/xpn}InquiryXpn" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class InquiryList {
    ...
    protected List<InquiryXpn> inquiry;
     ...
     * 
     */
    public List<InquiryXpn> getInquiry() {
        if (inquiry == null) {
            inquiry = new ArrayList<InquiryXpn>();
        }
        return this.inquiry;
    }
