 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Tradeline" type="{http://fico.com/dms/fidms/cc/cdac/xpn}TradelineXpn" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class TradelineList {
    ...
    protected List<TradelineXpn> tradeline;
     ...
     * 
     */
    public List<TradelineXpn> getTradeline() {
        if (tradeline == null) {
            tradeline = new ArrayList<TradelineXpn>();
        }
