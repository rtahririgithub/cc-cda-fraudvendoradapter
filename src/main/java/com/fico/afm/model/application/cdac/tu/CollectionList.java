 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Collection" type="{http://fico.com/dms/fidms/cc/cdac/tu}CollectionTu" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class CollectionList {
    ...
    protected List<CollectionTu> collection;
     ...
     * 
     */
    public List<CollectionTu> getCollection() {
        if (collection == null) {
            collection = new ArrayList<CollectionTu>();
        }
