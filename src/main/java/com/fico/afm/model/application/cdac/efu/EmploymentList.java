 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Employment" type="{http://fico.com/dms/fidms/cc/cdac/efu}EmploymentEfu" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class EmploymentList {
    ...
    protected List<EmploymentEfu> employment;
     ...
     * 
     */
    public List<EmploymentEfu> getEmployment() {
        if (employment == null) {
            employment = new ArrayList<EmploymentEfu>();
        }
