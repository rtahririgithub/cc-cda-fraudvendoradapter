 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Employment" type="{http://fico.com/dms/fidms/cc/cdac/tu}EmploymentTu" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class EmploymentList {
    ...
    protected List<EmploymentTu> employment;
     ...
     * 
     */
    public List<EmploymentTu> getEmployment() {
        if (employment == null) {
            employment = new ArrayList<EmploymentTu>();
        }
