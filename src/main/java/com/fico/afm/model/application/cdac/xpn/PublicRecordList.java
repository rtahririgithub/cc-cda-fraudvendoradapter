 ...
 *       &lt;sequence&gt;
 *         &lt;element name="PublicRecord" type="{http://fico.com/dms/fidms/cc/cdac/xpn}PublicRecordXpn" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "PublicRecordList")
public class PublicRecordList {

    @XmlElement(name = "PublicRecord", required = true)
    protected List<PublicRecordXpn> publicRecord;
     ...
     * {@link PublicRecordXpn }
     * 
     * 
     */
    public List<PublicRecordXpn> getPublicRecord() {
        if (publicRecord == null) {
            publicRecord = new ArrayList<PublicRecordXpn>();
        }
