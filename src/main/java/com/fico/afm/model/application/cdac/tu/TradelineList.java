 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Tradeline" type="{http://fico.com/dms/fidms/cc/cdac/tu}TradelineTu" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class TradelineList {
    ...
    protected List<TradelineTu> tradeline;
     ...
     * 
     */
    public List<TradelineTu> getTradeline() {
        if (tradeline == null) {
            tradeline = new ArrayList<TradelineTu>();
        }
