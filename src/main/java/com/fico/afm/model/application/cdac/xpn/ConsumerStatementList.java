 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ConsumerStatement" type="{http://fico.com/dms/fidms/cc/cdac/xpn}ConsumerStatementXpn" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ConsumerStatementList {
    ...
    protected List<ConsumerStatementXpn> consumerStatement;
     ...
     * {@link ConsumerStatementXpn }
     * 
     * 
     */
    public List<ConsumerStatementXpn> getConsumerStatement() {
        if (consumerStatement == null) {
            consumerStatement = new ArrayList<ConsumerStatementXpn>();
        }
