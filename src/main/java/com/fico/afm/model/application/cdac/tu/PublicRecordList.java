 ...
 *       &lt;sequence&gt;
 *         &lt;element name="PublicRecord" type="{http://fico.com/dms/fidms/cc/cdac/tu}PublicRecordTu" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class PublicRecordList {
    ...
    protected List<PublicRecordTu> publicRecord;
     ...
     * 
     */
    public List<PublicRecordTu> getPublicRecord() {
        if (publicRecord == null) {
            publicRecord = new ArrayList<PublicRecordTu>();
        }
