 ...
 *       &lt;sequence&gt;
 *         &lt;element name="ConsumerStatement" type="{http://fico.com/dms/fidms/cc/cdac/tu}ConsumerStatementTu" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class ConsumerStatementList {
    ...
    protected List<ConsumerStatementTu> consumerStatement;
     ...
     * {@link ConsumerStatementTu }
     * 
     * 
     */
    public List<ConsumerStatementTu> getConsumerStatement() {
        if (consumerStatement == null) {
            consumerStatement = new ArrayList<ConsumerStatementTu>();
        }
