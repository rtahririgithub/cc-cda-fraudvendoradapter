 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Inquiry" type="{http://fico.com/dms/fidms/cc/cdac/efu}InquiryEfu" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class InquiryList {
    ...
    protected List<InquiryEfu> inquiry;
     ...
     * 
     */
    public List<InquiryEfu> getInquiry() {
        if (inquiry == null) {
            inquiry = new ArrayList<InquiryEfu>();
        }
        return this.inquiry;
    }
