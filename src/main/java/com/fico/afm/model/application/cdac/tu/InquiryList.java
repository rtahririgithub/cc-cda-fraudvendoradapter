 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Inquiry" type="{http://fico.com/dms/fidms/cc/cdac/tu}InquiryTu" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class InquiryList {
    ...
    protected List<InquiryTu> inquiry;
     ...
     * 
     */
    public List<InquiryTu> getInquiry() {
        if (inquiry == null) {
            inquiry = new ArrayList<InquiryTu>();
        }
        return this.inquiry;
    }
