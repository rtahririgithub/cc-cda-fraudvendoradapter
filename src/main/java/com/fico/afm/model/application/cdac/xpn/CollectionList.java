 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Collection" type="{http://fico.com/dms/fidms/cc/cdac/xpn}CollectionXpn" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class CollectionList {
    ...
    protected List<CollectionXpn> collection;
     ...
     * 
     */
    public List<CollectionXpn> getCollection() {
        if (collection == null) {
            collection = new ArrayList<CollectionXpn>();
        }
