 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Tradeline" type="{http://fico.com/dms/fidms/cc/cdac/efu}TradelineEfu" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "TradelineList")
public class TradelineList {

    @XmlElement(name = "Tradeline", required = true)
    protected List<TradelineEfu> tradeline;
     ...
     * 
     */
    public List<TradelineEfu> getTradeline() {
        if (tradeline == null) {
            tradeline = new ArrayList<TradelineEfu>();
        }
