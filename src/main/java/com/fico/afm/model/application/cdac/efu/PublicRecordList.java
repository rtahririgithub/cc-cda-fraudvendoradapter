 ...
 *       &lt;sequence&gt;
 *         &lt;element name="PublicRecord" type="{http://fico.com/dms/fidms/cc/cdac/efu}PublicRecordEfu" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class PublicRecordList {
    ...
    protected List<PublicRecordEfu> publicRecord;
     ...
     * {@link PublicRecordEfu }
     * 
     * 
     */
    public List<PublicRecordEfu> getPublicRecord() {
        if (publicRecord == null) {
            publicRecord = new ArrayList<PublicRecordEfu>();
        }
