 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Employment" type="{http://fico.com/dms/fidms/cc/cdac/xpn}EmploymentXpn" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class EmploymentList {
    ...
    protected List<EmploymentXpn> employment;
     ...
     * 
     */
    public List<EmploymentXpn> getEmployment() {
        if (employment == null) {
            employment = new ArrayList<EmploymentXpn>();
        }
