 ...
 *       &lt;sequence&gt;
 *         &lt;element name="Collection" type="{http://fico.com/dms/fidms/cc/cdac/efu}CollectionEfu" maxOccurs="unbounded"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class CollectionList {
    ...
    protected List<CollectionEfu> collection;
     ...
     * 
     */
    public List<CollectionEfu> getCollection() {
        if (collection == null) {
            collection = new ArrayList<CollectionEfu>();
        }
