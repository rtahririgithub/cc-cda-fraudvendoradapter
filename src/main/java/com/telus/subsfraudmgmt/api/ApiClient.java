...
import com.telus.subsfraudmgmt.auth.ApiKeyAuth;
import com.telus.subsfraudmgmt.auth.Authentication;
import com.telus.subsfraudmgmt.auth.HttpBasicAuth;
import com.telus.subsfraudmgmt.auth.OAuth;
...
//import io.swagger.CustomInstantDeserializer;
import io.swagger.RFC3339DateFormat;

@Component
//@Component("com.telus.subsfraudmgmt.api.ApiClient")
public class ApiClient {
	private static final Log LOG = CustomizedLogFactory.getLog(ApiClient.class);
    ...
    private String basePath = "https://TBD/pass-api-key/ml/v4/deployments/de74979e-f48e-42d0-b21d-53b3f579e6fd/";
    ...
    public ApiClient() {
        this.myRestTemplate = buildRestTemplate();
        init();
    }
    @Autowired   
    public ApiClient(RestTemplate myRestTemplate) {
    ...
    public void setDebugging(boolean debugging) {
        List<ClientHttpRequestInterceptor> currentInterceptors = this.myRestTemplate.getInterceptors();
        if(debugging) {
            ...
            this.myRestTemplate.setInterceptors(currentInterceptors);
        } else {
    ...
    public ApiClient setDateFormat(DateFormat dateFormat) {
        ...
        for(HttpMessageConverter converter:myRestTemplate.getMessageConverters()){
    ...
    */
    ...
    public <T> ResponseEntity<T> invokeAPI(String path, HttpMethod method, MultiValueMap<String, String> queryParams, Object body, HttpHeaders headerParams, MultiValueMap<String, Object> formParams, List<MediaType> accept, MediaType contentType, String[] authNames, ParameterizedTypeReference<T> returnType) throws RestClientException {
        ...
        //final UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(basePath).path("/predictions").queryParam("version", "2021-08-27");
      //per new  watsonai endpoint  deployed to GKE changed from customer/aifraudprediction/v1/predictions?version=2021-08-27 to customer/aifraudprediction/v1/fraudai/v1/predictions
        ...
        */
		...
		responseEntity = myRestTemplate.exchange(requestEntity, returnType);
		
		if (null==responseEntity) {
			throw new RestClientException("API returned null responseEntity");
		}

		long endTime = System.nanoTime();
        long elapsedTime = endTime - startTime;	        
        double elapsedTimeMilliseconds = elapsedTime * 1e-6;
        LogUtil.logPerformance("predictionApi.prediction restTemplate Elapsed time: " + elapsedTimeMilliseconds + " milliseconds");
    ...
    protected RestTemplate buildRestTemplate() {
    	if(myRestTemplate==null) {
	        ...
	        myRestTemplate.setRequestFactory(new BufferingClientHttpRequestFactory(myRestTemplate.getRequestFactory()));
    	}
